...
- (void)layoutSubviews {
	...
	indicatorF.origin.y = yPos + View_Location;
	...
	CGRect labelF;
	labelF.origin.y = yPos + View_Location;
	...
	detailsLabelF.origin.y = yPos + View_Location;
...
- (void)drawRect:(CGRect)rect {
	...
	CGRect boxRect = CGRectMake(roundf((allRect.size.width - size.width) / 2) + self.xOffset,
								roundf((allRect.size.height - size.height) / 2) + self.yOffset + View_Location, size.width, size.height);
	float radius = 10.0f;
