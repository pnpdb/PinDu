...
@interface PNPMessageBubbleHelper ()
{
    NSCache *_attributedStringCache;
}
@end

@implementation PNPMessageBubbleHelper

+ (instancetype)sharedMessageBubbleHelper {
    static PNPMessageBubbleHelper *sharedInstance = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[PNPMessageBubbleHelper alloc] init];
    });
