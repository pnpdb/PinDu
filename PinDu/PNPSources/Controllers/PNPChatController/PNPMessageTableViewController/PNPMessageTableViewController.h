//
//  PNPMessageTableViewController.h
//  PinDu
//
...
@protocol PNPMessageTableViewControllerDelegate <NSObject>
...
@protocol PNPMessageTableViewControllerDataSource <NSObject>
...
@interface PNPMessageTableViewController : UIViewController<UITableViewDataSource, UITableViewDelegate, PNPMessageTableViewControllerDelegate, PNPMessageTableViewControllerDataSource, PNPMessageInputViewDelegate, XHMessageTableViewCellDelegate, PNPShareMenuViewDelegate, PNPEmotionManagerViewDelegate, PNPEmotionManagerViewDataSource>

@property (nonatomic, weak) id <PNPMessageTableViewControllerDelegate> delegate;

@property (nonatomic, weak) id <PNPMessageTableViewControllerDataSource> dataSource;
 ...
 *  用于显示消息的TableView
 */
@property (nonatomic, weak, readonly) PNPMessageTableView *messageTableView;

/**
 *  用于显示发送消息类型控制的工具条，在底部
 */
@property (nonatomic, weak, readonly) PNPMessageInputView *messageInputView;

/**
 *  替换键盘的位置的第三方功能控件
 */
@property (nonatomic, weak, readonly) PNPShareMenuView *shareMenuView;


/**
 *  管理第三方gif表情的控件
 */
@property (nonatomic, weak, readonly) PNPEmotionManagerView *emotionManagerView;
 ...
 *  输入框的样式，默认为扁平化
 */
@property (nonatomic, assign) PNPMessageInputViewStyle inputViewStyle;
