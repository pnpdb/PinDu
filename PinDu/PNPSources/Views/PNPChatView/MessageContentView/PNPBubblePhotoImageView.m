...
#import "PNPBubblePhotoImageView.h"
#import "PNPMacro.h"
#import "UIView+RemoteImage.h"

#import "UIImage+Resize.h"

@interface PNPBubblePhotoImageView ()

@property (nonatomic, assign) PNPBubbleMessageType bubbleMessageType;

@end

@implementation PNPBubblePhotoImageView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.bubbleMessageType == PNPBubbleMessageTypeSending) {
