...
@interface PNPMessageBubbleView : UIView

/**
 *  目标消息Model对象
 */
@property (nonatomic, strong, readonly)  id <PNPMessageProtocol> message;
 ...
 *  用于显示仿微信发送图片的控件
 */
@property (nonatomic, weak, readonly) PNPBubblePhotoImageView *bubblePhotoImageView;
