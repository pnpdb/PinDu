...
#define kPNPVoiceRecordPauseString @"手指上滑，取消发送"
#define kPNPVoiceRecordResaueString @"松开手指，取消发送"

@interface PNPVoiceRecordHUD ()
...
@implementation PNPVoiceRecordHUD
...
- (void)setup {
    ...
    if (!_remindLabel) {
        ...
        remindLabel.text = kPNPVoiceRecordPauseString;
